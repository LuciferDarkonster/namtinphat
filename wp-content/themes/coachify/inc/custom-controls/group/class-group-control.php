<?php
/**
 * Coachify Customizer Group Control.
 */
...
class Coachify_Group_Control extends WP_Customize_Control {
	/**
    ...
    public function enqueue() {            
        wp_enqueue_style( 'coachify-group', get_template_directory_uri() . '/inc/custom-controls/group/group.css', null );
        wp_enqueue_script( 'coachify-group', get_template_directory_uri() . '/inc/custom-controls/group/group.js', array( 'jquery' ), false, true ); //for group        
    }
	...
	public function content_template()
	{
		...
		#>
		<div data-grpid="{{data.id}}" class="coachify-customizer-group coachify-customizer-group-{{ data.style }} <# if ( ! data.collapsed ) { #>is-active<# } #>">
			<div class="group-head">
				...
				<# } else { #>
					...
					<# if ( data.style == 'edit' ) { #>
						<button class="head-edit group-content-toggle" title="<?php echo esc_attr__('Show Panel', 'coachify'); ?>">
